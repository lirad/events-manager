...
class EventAtendeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_atendee" do
    assert_difference('EventAtendee.count') do
      post event_atendees_url, params: { event_atendee: { event_id: @event_atendee.event_id, user_id: @event_atendee.user_id } }
    end
  ...
  test "should update event_atendee" do
    patch event_atendee_url(@event_atendee), params: { event_atendee: { event_id: @event_atendee.event_id, user_id: @event_atendee.user_id } }
